...
void LoadFromKey(HKEY settingsKey, Config &config)
{
	...
	RegistrySettings::Read32BitValueFromRegistry(settingsKey, L"EnableExpandableFolders",
		config.enableExpandableFolders);
...
void SaveToKey(HKEY settingsKey, const Config &config)
{
	...
	RegistrySettings::SaveDword(settingsKey, L"EnableFastPathIO", config.enableFastPathIO);
	RegistrySettings::SaveDword(settingsKey, L"EnableLazyTabRestoration",
		config.enableLazyTabRestoration);
	RegistrySettings::SaveDword(settingsKey, L"EnableExpandableFolders",
		config.enableExpandableFolders);
