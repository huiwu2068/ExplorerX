...
void LoadFromNode(IXMLDOMNode *settingsNode, Config &config)
{
	...
	GetBoolSetting(settingsNode, L"DualPane", config.dualPane);
	GetIntSetting(settingsNode, L"DualPaneSplitRatio", config.dualPaneSplitRatio);
	...
	GetBoolSetting(settingsNode, L"EnableExpandableFolders", config.enableExpandableFolders);
...
void SaveToNode(IXMLDOMDocument *xmlDocument, IXMLDOMElement *settingsNode, const Config &config)
{
	...
	XMLSettings::WriteStandardSetting(xmlDocument, settingsNode, SETTING_NODE_NAME, L"DualPane",
		XMLSettings::EncodeBoolValue(config.dualPane));
	XMLSettings::WriteStandardSetting(xmlDocument, settingsNode, SETTING_NODE_NAME,
	...
	XMLSettings::WriteStandardSetting(xmlDocument, settingsNode, SETTING_NODE_NAME,
		L"EverythingRegex",
		XMLSettings::EncodeBoolValue(config.everythingSearchSettings.regularExpression));
	XMLSettings::WriteStandardSetting(xmlDocument, settingsNode, SETTING_NODE_NAME,
	...
	XMLSettings::WriteStandardSetting(xmlDocument, settingsNode, SETTING_NODE_NAME,
		L"EnableExpandableFolders", XMLSettings::EncodeBoolValue(config.enableExpandableFolders));
	XMLSettings::WriteStandardSetting(xmlDocument, settingsNode, SETTING_NODE_NAME,
