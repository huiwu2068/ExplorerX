...
void OnUpdateReplaceExplorerSetting(DefaultFileManager::ReplaceExplorerMode updatedReplaceMode)
{
	...
	case DefaultFileManager::ReplaceExplorerMode::None:
		...
		{
			std::wcout << L"ExplorerX successfully removed as default file manager.\n"
					   << std::endl;
		}
		else
		{
			std::wcerr << L"Could not remove ExplorerX as default file manager." << std::endl;
		}
		break;
	...
	case DefaultFileManager::ReplaceExplorerMode::All:
		...
		{
			std::wcout << L"ExplorerX successfully set as default file manager." << std::endl;
		}
		else
		{
			std::wcerr << L"Could not set ExplorerX as default file manager." << std::endl;
		}
		break;
	}
}
