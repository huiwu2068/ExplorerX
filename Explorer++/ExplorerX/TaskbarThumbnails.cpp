...
void TaskbarThumbnails::CreateTabProxy(const Tab &tab)
{
	...
	std::wstring proxyClassName = std::format(L"ExplorerXTabProxy{}", proxyCount++);
...
void TaskbarThumbnails::OnDirectoryPropertiesChanged(const ShellBrowser *shellBrowser)
{
