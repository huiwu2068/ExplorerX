...
void Explorerplusplus::UpdateLayout()
{
	...
	// Skip layout when the window has no valid client area (e.g. during minimize/restore
	// transition). Without this guard, m_treeViewWidth would be permanently clamped to a
	// near-zero value by the TREEVIEW_MAXIMUM_WIDTH_PERCENTAGE * 0 calculation below.
