...
inline const wchar_t REGISTRY_APPLICATION_KEY_PATH[] = L"Software\\ExplorerX";
...
inline const wchar_t CONFIG_FILE_ROOT_NODE_NAME[] = L"ExplorerX";
inline const wchar_t CONFIG_FILE_SETTINGS_NODE_NAME[] = L"Settings";
inline const wchar_t CONFIG_FILE_ENV_VAR_NAME[] = L"EXPLORERX_CONFIG";
